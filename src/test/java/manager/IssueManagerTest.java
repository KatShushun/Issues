...
class CRUDIssueManagerTest {
    ...
    public class Empty {
        ...
        void shouldOpenIssue() {
            assertThrows(manager.NotFoundException.class, () -> manager.openIssue(1));
        }

        @Test
        void shouldCloseIssue() {
            assertThrows(manager.NotFoundException.class, () -> manager.closeIssue(6));
        }
    }
    ...
    public class SingleItem {
        ...
        void shouldOpenIssueNotExist() {
            assertThrows(manager.NotFoundException.class, () -> manager.closeIssue(2));
        }
    }
